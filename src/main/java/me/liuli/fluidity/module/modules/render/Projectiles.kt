...
class Projectiles : Module("Projectiles", "Allows you to see where arrows will land", ModuleCategory.RENDER) {
    ...
    fun onRender3D(event: Render3DEvent) {
        ...
        glColor(if (hitEntity) { Color(255, 140, 140) } else { Color(140, 255, 140) })
        GL11.glLineWidth(2f)
        ...
        if (landingPosition != null) {
            ...
            drawAxisAlignedBB(AxisAlignedBB(-0.5, 0.0, -0.5, 0.5, 0.1, 0.5), if (hitEntity) { Color(255, 140, 140) } else { Color(140, 255, 140) }, 3f)
        }
        GL11.glPopMatrix()
